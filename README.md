...
This repository contains the conceptual definition and theoretical framework for **Neural Network Construction**, 
...
├── LICENSE             # CC BY 4.0
├── paper/
│   └── neural-network-construction.tex    # LaTeX dissertation
├── whitepaper/
│   └── neural-network-construction.md     # White paper
└── translations/
    ├── de/             # German
    ├── en/             # English
    ├── tr/             # Turkish
...
```bibtex
@misc{vega2025neuralnetworkconstruction,
  author = {Vega, Adam Eren},
  title = {Neural Network Construction: A Conceptual Framework},
  year = {2025},
  publisher = {GitHub},
  url = {https://github.com/vegafoundation/neural-network-construction}
}
```
